...
export const PLASMA_FRAGMENT = `
    ...
    void main() {
        ...
        float alpha = smoothstep(uThreshold, 0.75, t);
        vec3 cWhite = vec3(1.0, 1.0, 1.0);
        vec3 color = mix(uColorDeep, uColorMid, smoothstep(uThreshold, 0.45, t));
        color = mix(color, uColorBright, smoothstep(0.45, 0.75, t));
        color = mix(color, cWhite, smoothstep(0.75, 1.0, t));
